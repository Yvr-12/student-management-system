...
login_frame = Frame(width=1000, height=600)
login_frame.pack(fill=BOTH, expand=True)

Label(login_frame, text="Login", font=headlabelfont, bg='SpringGreen').pack(side=TOP, fill=X)

username_label = Label(login_frame, text="Username", font=labelfont, bg='SpringGreen')
username_label.place(relx=0.375, rely=0.3)
password_label = Label(login_frame, text="Password", font=labelfont, bg='SpringGreen')
password_label.place(relx=0.375, rely=0.45)

username_entry = Entry(login_frame, width=19, font=entryfont)
username_entry.place(x=20, rely=0.3)
password_entry = Entry(login_frame, width=19, font=entryfont, show='*')
password_entry.place(x=20, rely=0.45)

login_button = Button(login_frame, text='Login', font=labelfont, command=login, width=18)
login_button.place(relx=0.025, rely=0.6)
